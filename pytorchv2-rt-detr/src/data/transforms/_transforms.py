...
CenterCrop = register()(T.CenterCrop)
ToImage = register()(T.ToImage)
# torchvision's ToDtype requires an explicit dtype; default to float32 for convenience.
...
class ToDtype(T.ToDtype):
    def __init__(self, dtype='float32', scale=False):
        resolved_dtype = _resolve_dtype(dtype)
        super().__init__(resolved_dtype, scale=scale)
